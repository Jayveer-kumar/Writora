      ...
      {isDesktopView ? (
        <>
          <div className="nav-right nav-right-desktop  flex items-center gap-2 text-brand-text ">
            <button
              onClick={toggleMode}
              className=" darkModeButton  cursor-pointer p-2  text-gray-500 hover:text-gray-800 rounded-full relative"
            >
            ...
            <Link to={"/auth?currentAction=signup"} >
             <button className=" cursor-pointer bg-brand-text text-brand-bg px-4 py-3 rounded-2xl font-semibold shadow-lg hover:opacity-90 transition-transform active:scale-95 ">
              {" "}
