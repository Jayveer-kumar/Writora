...
export default function SearchInput( { value, onChange , onHandleSearch } ) {
  return (
    <div className="search-input-container w-full max-w-md mx-auto py-10 ">
      <div className="relative group flex items-center">
        ...
        <button onClick={onHandleSearch} className="absolute right-1.5 h-9 px-5 bg-brand-green hover:bg-brand-green-hover text-white font-medium rounded-xl transition-all duration-200 active:scale-95 cursor-pointer shadow-md" >
          Search
        </button>
      </div>
    </div>
